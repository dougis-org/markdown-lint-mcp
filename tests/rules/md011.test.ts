...
const testCases = [
  ...
  },
  {
    ...
    expectedFixedMarkdown:
      'This [valid link](https://example.com) and [invalid link](https://example.org).',
  },
  {
    name: 'Reversed links on multiple lines',
    markdown:
      'First line has (reversed)[https://example.com] link.\n\nSecond line has (another reversed)[https://example.org] link.',
    expectedViolations: 2,
  ...
  },
  {
    ...
    expectedLineNumbers: [1],
    expectedFixedMarkdown:
      'Check out [My "Special" Link](https://example.com/path?param=value&other=123).',
  },
  {
  ...
  },
  {
    ...
    markdown:
      '- First item with (reversed)[https://example.com] link\n- Second item with normal [link](https://example.org)',
    expectedViolations: 1,
    expectedLineNumbers: [1],
    expectedFixedMarkdown:
      '- First item with [reversed](https://example.com) link\n- Second item with normal [link](https://example.org)',
